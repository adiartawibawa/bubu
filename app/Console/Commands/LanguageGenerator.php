...
class LanguageGenerator extends Command
{
    ...
    {
        // Mendapatkan nilai argumen dan opsi yang diberikan
        ...
        // Memeriksa apakah sumber adalah direktori atau file JSON
        ...
        // Memproses berdasarkan apakah hanya file JSON yang diminta
        if ($onlyJson) {
    ...
    protected function processJsonFile(string $sourceFile, string $from, array|string $targets): void
    {
        foreach ($targets as $to) {
            ...
            // Mendapatkan konten dari file JSON
            ...
            // Menyimpan hasil terjemahan ke file target
