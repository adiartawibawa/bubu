<x-layouts.main>
    <div class="relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-800">
        <div x-data="{ openMenu: false }" :class="openMenu ? 'overflow-hidden' : 'overflow-visible'"
            ...
            <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
                ...
                <main
                    class="flex flex-col h-screen justify-between pt-2 pb-24 pl-2 pr-2 overflow-y-auto no-scrollbar md:pt-0 md:pr-0 md:pl-0 mb-auto">

                    <div class="flex flex-col flex-wrap sm:flex-row mb-auto">
                        <div class="flex w-full text-slate-500 items-start justify-between">
                            @if (isset($header))
                                <x-page-header>
                                    {{ $header }}
                                </x-page-header>
