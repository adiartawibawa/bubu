<header class="z-40 items-center w-full h-16 bg-white shadow-lg dark:bg-gray-700 md:rounded-2xl">
    <div class="relative z-20 flex flex-col justify-center h-full pl-2 mx-auto flex-center">
        <div class="relative flex items-center w-full lg:max-w-68 sm:pr-2 sm:ml-0 py-4">
            <div class="container relative left-0 z-50 flex items-center w-3/4 space-x-2">

                <div class="relative inline-block">
                    <!-- Mobile Menu Toggle -->
                    <button class="flex lg:hidden flex-col items-center align-middle" @click="openMenu = !openMenu"
                ...
                <div class="relative flex items-center w-full h-full lg:w-64 group">
                    ...
                    <input type="text" id="Search" placeholder="Search for..."
                        class="w-full rounded-xl border-gray-200 py-2.5 pe-10 shadow-sm sm:text-sm" />
            ...
            <div class="flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto">
                <div x-data="{ isOpen: true }" class="relative mr-2">
                    ...
                    <!-- Dropdown menu -->
                    <div x-cloak x-show="!isOpen" @click.away="isOpen = true"
                        ...
                        <div class="py-2">
                            <a href="#"
                                ...
                                <p class="mx-2 text-sm text-gray-600 dark:text-white"><span class="font-bold"
                                        href="#">Sara Salah</span> replied on
                                    the <span class="text-indigo-500 hover:underline" href="#">Upload Image</span>
                                    artical . 2m</p>
                            </a>
                            <a href="#"
                                class="flex items-center px-4 py-3 -mx-2 transition-colors duration-300 transform border-b border-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 dark:border-gray-700">
                            ...
                            <a href="#"
                                ...
                                <img class="flex-shrink-0 object-cover w-8 h-8 mx-1 rounded-full"
                                    ...
                                    alt="avatar" />
                                <p class="mx-2 text-sm text-gray-600 dark:text-white"><span class="font-bold"
                                        href="#">Jane Doe</span> Like Your
                                    reply on <span class="text-blue-500 hover:underline" href="#">Test with
                                        TDD</span> artical . 1h</p>
                            </a>
                            <a href="#"
                                ...
                                <img class="flex-shrink-0 object-cover w-8 h-8 mx-1 rounded-full"
                                    ...
                                    alt="avatar" />
                                <p class="mx-2 text-sm text-gray-600 dark:text-white"><span class="font-bold"
                                        href="#">Abigail Bennett</span> start
                                    following you . 3h</p>
                            </a>
                        </div>
                        <a href="#"
                ...
                <div x-data="{ isOpen: true }" class="relative">
                    ...
                    <div x-cloak x-show="!isOpen" @click.away="isOpen = true"
                        ...
                        x-transition:leave="transition ease-in duration-100"
                        x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90"
                        class="absolute z-50 right-0 w-56 py-2 mt-4 overflow-hidden origin-top-right bg-white rounded-md shadow-xl dark:bg-gray-800">
                        <a href="#"
                        ...
                        <a href="{{ url('/admin') }}"
                            class="flex items-center p-3 text-sm text-red-600 capitalize transition-colors duration-300 transform dark:text-red-300 hover:bg-red-100 dark:hover:bg-red-700 dark:hover:text-white">
                            <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
