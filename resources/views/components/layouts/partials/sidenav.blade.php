<div>
    <div class="relative hidden h-screen my-4 ml-4 lg:block">
        <aside
            class="flex flex-col w-64 rounded-2xl h-screen px-5 pt-4 pb-6 overflow-y-auto no-scrollbar bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
